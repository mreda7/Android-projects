...
import com.gen.select.radioapp.stations.presenter.StationsPresenter;
import com.gen.select.radioapp.utils.ActivityUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (stationsFragment == null) {
            ...
            ActivityUtils.addFragmentToActivity(
                    getSupportFragmentManager(), stationsFragment, R.id.contentFrame);
        }
